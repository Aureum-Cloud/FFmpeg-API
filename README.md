# Media Processing HTTP API (FFmpeg)

A **general-purpose HTTP API** for processing video, audio, and images using **FFmpeg**.
...
```
aureum-cloud/processing-api
```

### Run

```bash
docker run -d -p 8080:8080 aureum-cloud/processing-api
```
